  ...
  return (
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        ...
        <Button customFunc={()=>handleOff('notification')} 
        text={<MdOutlineCancel />} color={currentColor} size="2xl" borderRadius="50%" />
      </div>
      <div className="mt-5 ">
        ...
        <div className="mt-5">
          <Button customFunc={()=>handleOff('notification')}
           color="white" bgColor={currentColor} text="See all notifications" borderRadius="10px" width="full" />
        </div>
      </div>
    </div>
  );
